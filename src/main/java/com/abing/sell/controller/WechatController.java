...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnurl") String returnUrl){
        ...
        String redirectUrl=wxMpService.oauth2buildAuthorizationUrl(url,WxConsts.OAUTH2_SCOPE_USER_INFO, java.net.URLEncoder.encode(returnUrl));
    ...
    public String qrauthorize(@RequestParam("returnUrl") String returnUrl){
        ...
        String redirectUrl=wxOpenService.buildQrConnectUrl(url,WxConsts.QRCONNECT_SCOPE_SNSAPI_LOGIN, java.net.URLEncoder.encode(returnUrl));
        return "redirect:" + redirectUrl;
    }
